# Generated by Django 3.0 on 2020-05-15 06:10
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('inmueble', models.CharField(blank=True, max_length=80, null=True)),
                ('coeficiente', models.DecimalField(blank=True, decimal_places=3, max_digits=10, null=True)),
                ('documento', models.CharField(blank=True, max_length=20, null=True)),
                ('celular', phonenumber_field.modelfields.PhoneNumberField(max_length=128, null=True, region=None)),
